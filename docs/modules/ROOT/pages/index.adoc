...
If you want to use this extension, you need to add the `io.quarkiverse.homeassistant:quarkus-homeassistant` extension first to your build file.
...
include::includes/quarkus-homeassistant.adoc[leveloffset=+1, opts=optional]
